...
- [x] **1.1 Three-question flow renders and resolves to a verdict**
...
- [x] **1.2 Decision tree covers every question-path combination**
...
- [x] **1.3 "Not sure" answers steer to the conservative verdict**
...
- [x] **2.1 Live-annotating plug diagram**
...
- [x] **2.2 Full design-token application**
...
- [x] **2.4 Responsive composition at 390 / 768 / 1440**
...
- [x] **3.1 Full keyboard and screen-reader operability**
...
- [x] **3.2 Favicon and brand wordmark**
...
- [x] **3.3 Device-type question frames but never changes the verdict**
...
- [x] **4.1 Static build deploys as a relative-path bundle**
...
- [x] **4.2 CI stays green through the full build**
